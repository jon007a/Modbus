...
namespace {
struct qt_meta_tag_ZN18ConnectionSettingsE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN18ConnectionSettingsE = QtMocHelpers::stringData(
    "ConnectionSettings",
    "settingsApplied",
    "",
    "connectionType",
...
Q_CONSTINIT static const uint qt_meta_data_ZN18ConnectionSettingsE[] = {
...
Q_CONSTINIT const QMetaObject ConnectionSettings::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN18ConnectionSettingsE.offsetsAndSizes,
    qt_meta_data_ZN18ConnectionSettingsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN18ConnectionSettingsE_t,
        // Q_OBJECT / Q_GADGET
...
void ConnectionSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ConnectionSettings::*)(QString , int , int , int , int , int , QString , int );
            if (_q_method_type _q_method = &ConnectionSettings::settingsApplied; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ConnectionSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN18ConnectionSettingsE.stringdata0))
